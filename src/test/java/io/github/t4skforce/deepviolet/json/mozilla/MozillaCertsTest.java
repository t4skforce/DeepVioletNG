...
public class MozillaCertsTest {
	...
	void testMapping(String resourceName) throws Exception {
		...
		assertThat(modern.getCiphersuites()).containsAnyOf("TLS_AES_128_GCM_SHA256", "TLS_AES_256_GCM_SHA384",
		...
		assertThat(internediate.getCiphersuites()).containsAnyOf("TLS_AES_128_GCM_SHA256", "TLS_AES_256_GCM_SHA384",
				"TLS_CHACHA20_POLY1305_SHA256");
		...
		assertThat(old.getCiphersuites()).containsAnyOf("TLS_AES_128_GCM_SHA256", "TLS_AES_256_GCM_SHA384",
				"TLS_CHACHA20_POLY1305_SHA256");
